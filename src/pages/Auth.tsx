      ...
      <motion.div className="w-full max-w-md space-y-6" variants={containerVariants} initial="hidden" animate="visible">
        ...
        <motion.div className="text-center space-y-2" variants={itemVariants}>
          ...
          <motion.div className="flex items-center justify-center gap-2 mb-2" whileHover={{ scale: 1.02 }}>
            ...
            <h1 className="text-2xl font-bold text-gradient-primary">Sign in to Hyvo.ai</h1>
          </motion.div>
                  ...
                  <form onSubmit={handleSignIn}>
                    ...
                    <CardFooter className="flex flex-col space-y-4">
                      ...
                      <div className="grid grid-cols-3 gap-3 w-full">
                        <Button type="button" variant="outline" onClick={signInWithTwitch} disabled={isLoading} className="liquid-glass-button" aria-label="Sign in with Twitch">
                          <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                            <path d="M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z" />
                          </svg>
                          <span className="sr-only">Sign in with Twitch</span>
                        </Button>
                        <Button type="button" variant="outline" onClick={signInWithGoogle} disabled={isLoading} className="liquid-glass-button" aria-label="Sign in with Google">
                        ...
                        <Button type="button" variant="outline" onClick={signInWithDiscord} disabled={isLoading} className="liquid-glass-button" aria-label="Sign in with Discord">
                          <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true">
