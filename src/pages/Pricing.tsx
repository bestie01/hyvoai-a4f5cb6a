        ...
        <section className="pt-32 pb-16 px-6 relative overflow-hidden">
          ...
          <div className="container mx-auto text-center relative">
            ...
            {user && !initialLoading && (
              ...
              >
                {isPro ? (
                  <div className="inline-flex items-center gap-2 px-6 py-3 glass-card shadow-glow-primary">
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {plans.map((plan, index) => (
              ...
              >
                <Card 
                  className={`relative h-full transition-all duration-300 hover-lift ${
                    plan.popular 
                      ? 'border-primary/50 shadow-glow-primary bg-gradient-card' 
                      : 'bg-card hover:border-primary/30'
                  } ${plan.isCurrent ? 'ring-2 ring-success' : ''}`}
                >
                  {plan.popular && (
                    <Badge 
                      className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-primary shadow-lg"
                    >
                  ...
                  {plan.isCurrent && (
                    <Badge 
                      className="absolute -top-3 right-4 bg-success text-success-foreground shadow-glow-success"
                    >
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                      <Button 
                        ...
                        size="lg" 
                        className={`w-full font-semibold ${plan.popular ? 'shadow-glow-primary' : ''}`}
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {[
                ...
                <motion.div
                  key={feature.title}
                  className="p-6 glass-card hover-lift cursor-pointer group"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto text-center relative">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto text-left">
            {[
              ...
              <motion.div
                key={faq.q}
                className="p-6 glass-card hover-lift text-left"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
