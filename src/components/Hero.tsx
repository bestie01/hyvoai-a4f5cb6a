...
import { Play, Sparkles, TrendingUp, Radio, ArrowRight, Download, Zap, Monitor, Mic, Video, Layers, Wand2, ChevronRight } from "lucide-react";
...
const Hero = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center bg-gradient-hero overflow-hidden">
      ...
      {/* Floating orbs */}
      <motion.div className="absolute top-[15%] left-[10%] w-64 h-64 bg-primary/20 rounded-full blur-[80px]" animate={{
      scale: [1, 1.2, 1],
      opacity: [0.3, 0.5, 0.3],
      x: [0, 20, 0],
      y: [0, -20, 0]
      ...
      <motion.div className="absolute bottom-[20%] right-[15%] w-80 h-80 bg-accent/15 rounded-full blur-[100px]" animate={{
      scale: [1, 1.15, 1],
      opacity: [0.2, 0.4, 0.2],
      x: [0, -30, 0],
      y: [0, 20, 0]
      ...
      <motion.div className="absolute top-[40%] right-[30%] w-48 h-48 bg-primary/10 rounded-full blur-[60px]" animate={{
      scale: [1, 1.3, 1],
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <FadeIn className="text-center lg:text-left space-y-10">
            ...
            delay: 0.2
              ...
              <Badge variant="secondary" className="inline-flex items-center gap-2 py-2.5 px-5 glass-strong rounded-full border-primary/20">
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-primary"></span>
                </span>
                <span className="font-semibold tracking-wide text-sm">Professional Streaming Studio</span>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-5 justify-center lg:justify-start">
                <motion.div className="w-20 h-20 flex items-center justify-center bg-gradient-primary rounded-2xl p-4 shadow-glow-primary" whileHover={{
                scale: 1.05,
                rotate: 5
              }} transition={{
                type: "spring",
              ...
              <h1 className="text-5xl lg:text-7xl xl:text-8xl font-display font-extrabold leading-[1.05] tracking-tight">
                ...
                <br />
                <motion.span className="text-foreground inline-block" initial={{
                opacity: 0,
                y: 30
              }} animate={{
                opacity: 1,
                ...
                delay: 0.5
              }} className="text-gradient-accent relative inline-block text-secondary-foreground bg-primary-foreground">
                  AI
              ...
              {/* Subheadline */}
              <motion.p className="text-xl lg:text-2xl text-muted-foreground max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
              ...
              delay: 0.6
                ...
                Multi-platform streaming, pro audio, and intelligent automation.
              </motion.p>
            </div>
            
            {/* Feature pills */}
            <motion.div className="flex flex-wrap gap-3 justify-center lg:justify-start" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            delay: 0.7
              ...
              {streamlabsFeatures.map((feature, idx) => <motion.div key={feature.label} initial={{
              opacity: 0,
              scale: 0.8
            }} animate={{
              opacity: 1,
            ...
            delay: 0.9
              ...
              <MagneticButton>
                <Button size="lg" className="group bg-gradient-primary hover:shadow-glow-primary-strong transition-all duration-500 font-bold text-lg px-10 py-7 rounded-2xl text-primary-foreground" onClick={() => user ? navigate('/studio') : navigate('/auth')}>
              ...
              <MagneticButton>
                <Button variant="outline" size="lg" className="glass-strong hover:bg-primary/5 border-border/60 hover:border-primary/50 font-bold text-lg px-10 py-7 rounded-2xl transition-all duration-500 group" onClick={() => navigate('/download')}>
            ...
            {/* Trust badges */}
            <motion.div className="flex items-center gap-8 justify-center lg:justify-start text-sm text-muted-foreground" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
          ...
          <FadeIn delay={0.4} className="relative">
            <RippleEffect>
              <motion.div className="relative overflow-hidden rounded-3xl glass-strong hover-lift transition-all duration-700 hover:shadow-glow-primary border border-border/50" whileHover={{
              scale: 1.01
            }} transition={{
              type: "spring",
              stiffness: 200
            }}>
                <img src={heroImage} alt="Hyvo.ai Dashboard Preview - AI-powered streaming analytics" className="w-full h-auto object-cover" loading="eager" />
