        ...
        <div className="text-center space-y-16">
          ...
          <ScrollReveal delay={0.3}>
            <div className="space-y-10 max-w-4xl mx-auto">
              <Badge
                variant="secondary"
                className="py-2.5 px-5 shine-effect glass-strong rounded-full border-primary/20 inline-flex items-center gap-2"
              >
                <Sparkles className="w-4 h-4 text-primary" />
                <span className="font-semibold">Ready to Transform Your Streams?</span>
              </Badge>

              <h2 className="text-4xl lg:text-6xl xl:text-7xl font-display font-extrabold leading-[1.1] tracking-tight">
                Stop <span className="text-gradient-primary">guessing.</span>
                <br />
                Start <span className="text-gradient-accent">growing.</span>
              </h2>

              <p className="text-xl lg:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Join thousands of streamers who've transformed their content with AI-powered insights
                and automation.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center items-center pt-4">
                <MagneticButton>
                  ...
                  >
                    ...
                    {user ? "Go to Studio" : "Start Streaming with AI"}
